...
For this homework, you will be using *hierarchical generalized additive models* to characterize daily minimum RH and daily maximum wind speeds using weather station data collected across a latitudinal gradient in the US Great Plains. The weather station data was collected from 2010 - 2019 and between days 121 - 273 in each year (roughly May - September). Specifically, you will be answering this question:
