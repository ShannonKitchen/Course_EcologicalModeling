...
# # NOTE: These are some superseded functions from tidyverse, but too lazy to modify now!
topmod.CI <- tidy(topmod)
...
# Need the 2.5 and 97.5 values in separate columns!
