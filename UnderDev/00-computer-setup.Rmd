...
* Follow the instructions for your distribution
  ...
  usually out of date. 
* In any case, make sure your R and RStudio are updated. A good function for updating R (relatively) painlessly is [installr::updateR](https://rdrr.io/cran/installr/man/updateR.html)
* Go to the
...
* Two options for saving data:
    ...
    <!-- 2. Upload your data file directly to the data folder on our [GitHub repository](https://github.com/LivingLandscape/Course_EcologicalModeling/tree/master/data). -->
...
*If you are not sure how to do any of the steps listed above, you can find instructions on the [lesson page](00-E-git-intro.html).*
